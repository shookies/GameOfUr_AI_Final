...
class Board:
    ...
    def __get_base_row_opponent(self):
        """
    ...
    def __is_move_legal(self, row, col):
        ...
        """
        base_row = self.__get_base_row()
        if row == self.__get_base_row_opponent():
    ...
    def __move_piece(self, row, col):
        ...
        if self.__opponent == self.__board[next_position[0]][next_position[1]]:
            ...
            self.__board[self.__get_base_row_opponent()][4] += 1
...
# b = Board()
# print(b._Board__current_dice_roll)
# b._current_dice_roll = [0,0,1,1]
# print(b._find_next_pos(2, 2))
# print(b._is_rosette(2, 3))
# b._Board__board[0][1] = 'W'
# b._Board__board[1][0] = 'W'
# b._Board__board[2][0] = 'B'
# b._Board__board[2][1] = 'B'
# b._Board__board[2][2] = 'B'
# print(b)
...
if __name__ == "__main__":
    ...
    for i in range(num_of_games):
        b = Board()
        b._Board__player_W = GreedyAgent('W')
        b._Board__player_B = ExpectiminimaxAgent('B', 'W', 2)
